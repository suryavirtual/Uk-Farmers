...
<?php if (!empty($filters['filter_search'])) : ?>
	<?php if ($searchButton) : ?>
		...
		<div class="btn-wrapper input-append">
            ...
            <input type="text" name="filter[search]" id="filter_search"  class="js-stools-search-string" placeholder="Search" data-original-title="" title="">
