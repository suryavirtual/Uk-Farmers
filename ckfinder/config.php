...
*/
	...
	{
   $arr =explode("/",$_GET['id']);
   $baseDir = $baseDir .$_GET['id'];
   $baseUrl = $baseUrl . $_GET['id'];
    }


//echo "baseurl".$baseUrl;
//die("testingsssssssssssssssssssssssssssssss");
/*
...
*/
//code commented by ve developer to stop unnessary folder
...
//code commented by vedeveloper for uneccary folder creation
...
$config['ResourceType'][] = Array(
		'name' => 'file_links',
		'url' => $baseUrl . 'file_links',
		'directory' => $baseDir . 'file_links',
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3,pdf,doc,xls,xlsx,docx',
		'deniedExtensions' => '');

 $config['ResourceType'][] = Array(
		'name' => 'logos',
		'url' => $baseUrl . 'logos',
		'directory' => $baseDir . 'logos',
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3',
		'deniedExtensions' => '');


/* condition for creating folder  automatically  for suppliers*/
  if($arr['0']== "suppliers")
	{
		/*$config['ResourceType'][] = Array(
		'name' => 'file_links',
		...
		'directory' => $baseDir . 'file_links',
		'maxSize' => "16M",
		'allowedExtensions' => 'pdf,doc,xls,xlsx,docx',
		'deniedExtensions' => ''); */

		$config['ResourceType'][] = Array(
		'name' => 'marketing',
		'url' => $baseUrl . 'marketing',
		'directory' => $baseDir . 'marketing',
		'maxSize' => "16M",
		'allowedExtensions' => 'pdf,doc,xls,xlsx,docx',
		'deniedExtensions' => '');
		...
		$config['ResourceType'][] = Array(
		'name' => 'pricelists',
		'url' => $baseUrl . 'pricelists',
		'directory' => $baseDir . 'pricelists',
		'maxSize' => "16M",
		'allowedExtensions' => 'pdf,doc,xls,xlsx,docx',
		'deniedExtensions' => '');
