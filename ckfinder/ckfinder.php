...
//config.basePath = "/ckfinder/";
 ...
 console.log(config);
//config.url='/uk_farmers/uf_data/images/';
//config.filebrowserImageBrowseUrl='/uk_farmers/uf_data/images/';
...
//};
//ckfinder.create();
//ckfinder.basePath="images/abs";
       //ckfinder.selectActionFunction('/images/abc/',data);
//
