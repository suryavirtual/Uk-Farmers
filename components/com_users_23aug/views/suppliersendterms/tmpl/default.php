...
jQuery(document).ready(function() 
{
	...
	jQuery("#results" ).load( "<?php echo JURI::root();?>/fetch_terms.php?user_id=<?php echo $usr_id; ?>",function(){ jQuery(".loading-div").hide();}); //load initial records
	...
	jQuery('#search').keyup(function(e) {
		if(e.keyCode == 13) {
			...
			jQuery("#results").load("<?php echo JURI::root();?>/fetch_terms.php?user_id=<?php echo $usr_id; ?>&val=" + jQuery("#search").val(),{"page":page}, function(){ //get content from PHP page
	...
	jQuery("#results").on( "click", ".pagination a", function (e){
		...
		jQuery("#results").load("<?php echo JURI::root();?>/fetch_terms.php?user_id=<?php echo $usr_id; ?>&val="+val,{"page":page}, function(){ //get content from PHP page
			jQuery(".loading-div").hide(); //once done, hide loading element
		});
	});
});
