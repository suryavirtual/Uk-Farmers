  ...
  */
	public function getList(){
		...
		if ($fileList !== false)
		{
          ...
          {
            case 'pdf':
            $tmp->path = str_replace(DIRECTORY_SEPARATOR, '/', (JURI::root() . '/images/upload/terms/index.jpg'));
            $tmp->filetype=$ext ;
            $filePath = str_replace(DIRECTORY_SEPARATOR, '/', JPath::clean($basePath . '/' . $file));
            $tmp->path_relative = str_replace($mediaBase, '', $filePath); 
            break;
              case 'docx':
            $tmp->path = str_replace(DIRECTORY_SEPARATOR, '/', (JURI::root() . '/images/upload/terms/index.jpg'));
            $tmp->filetype=$ext ;
