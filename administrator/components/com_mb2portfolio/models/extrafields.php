 ...
 */
class Mb2portfolioModelextrafields extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
		...
		//Filtering catid
		$this->setState('filter.download', $app->getUserStateFromRequest($this->context.'.filter.download', 'filter_download', '', 'string'));
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__mb2portfolio_extra_fields` AS a');
    ...
    if (is_numeric($published)) {
		...
		//Filtering catid
		$filter_download = $this->state->get("filter.extrafields");
		if ($filter_download){
			$query->where("a.extrafields = '".$db->escape($filter_catid)."'");
		}
