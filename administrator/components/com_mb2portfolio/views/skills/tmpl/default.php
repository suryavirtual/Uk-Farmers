...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_mb2portfolio&task=skills.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_mb2portfolio&view=skills'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="skillList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_MB2PORTFOLIO_SKILLS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php if (isset($item->checked_out) && $item->checked_out) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'skills.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_mb2portfolio&task=skill.edit&id='.(int) $item->id); ?>">
