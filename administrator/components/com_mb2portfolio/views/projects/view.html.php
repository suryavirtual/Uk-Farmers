...
class Mb2portfolioViewProjects extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		Mb2portfolioHelper::addSubmenu('projects');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MB2PORTFOLIO_PROJECTS_PAGE'), 'grid.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_mb2portfolio&view=projects');			
		$this->extra_sidebar = '';			
