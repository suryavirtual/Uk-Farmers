 ...
 * @since  0.0.1
 */
class SmAdminViewFmembers extends JViewLegacy
{
	/**
	...
	{
		$title = JText::_('COM_SMADMIN_MANAGER_FMEMBERS');
		...
		JToolBarHelper::publishList('fmembers.approved');
        JToolBarHelper::unpublishList('fmembers.unapproved');
