 ...
 * @since  0.0.1
 */
class SmAdminViewImport extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		$context = "smadmin.list.admin.product";
		...
		// Set the submenu
		SmAdminHelper::addSubmenu('import');
	...
	{
		$title = JText::_('Supplier/Member Notifications Import/Export');
