 ...
 * @since  0.0.1
 */
class SmAdminViewSmAdmins extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		$context = "smadmin.list.admin.smadmin";
	...
	{
		$title = JText::_('COM_SMADMIN_MANAGER_SMADMINS');
		...
		{
			JToolBarHelper::addNew('smadmin.add', 'JTOOLBAR_NEW');
		}
		if ($this->canDo->get('core.edit')) 
		{
			JToolBarHelper::editList('smadmin.edit', 'JTOOLBAR_EDIT');
		}
		if ($this->canDo->get('core.delete')) 
		{
			JToolBarHelper::deleteList('', 'smadmins.delete', 'JTOOLBAR_DELETE');
		}
