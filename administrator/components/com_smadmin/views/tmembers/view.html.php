 ...
 * @since  0.0.1
 */
class SmAdminViewTmembers extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::publishList('tmembers.approved');
        JToolBarHelper::unpublishList('tmembers.unapproved');
	...
	{
		$title = JText::_('COM_SMADMIN_MANAGER_TMEMBERS');
