				...
				<?php foreach ($this->form->getFieldset('user_details') as $field) : ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php endif; ?>
							<?php if ($field->fieldname == 'comp_list') : ?>
...
<script>
 jQuery(function() {
 	jQuery('select').chosen({width: "400px"});
 	jQuery('.chosen-toggle').each(function(index) {

    jQuery(this).on('click', function(){
   jQuery(this).parent().find('#jform_comp_list option').prop('selected', jQuery(this).hasClass('select')).parent().trigger("liszt:updated");
  });
