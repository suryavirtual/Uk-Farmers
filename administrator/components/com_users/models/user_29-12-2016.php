...
class UsersModelUser extends JModelAdmin
{
	...
	public function getItem($pk = null)
	{
		...
		$docType = explode(",",$result->doc_name);
		$result->doc_name = $docType;
		return $result;
	}
	...
	public function save($data)
	{
		...
		$my = JFactory::getUser();
		$data['doc_name'] = implode(',', $data['doc_name']);
		...
		else
		{
		    ...
		    $feedDir = $_SERVER['DOCUMENT_ROOT']."/uk_farmers/images/Supplier_Files/";
