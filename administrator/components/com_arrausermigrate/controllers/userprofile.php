...
class ArrausermigrateControllerUserprofile extends ArrausermigrateController{
    ...
    function userprofile(){
		JFactory::getApplication()->input->set("view", "userprofile");
	...
	function createFilter(){
		...
		$select = "";
		$field_id = JFactory::getApplication()->input->get("field_id", "0", "raw");
	...
	function search(){
		...
		$filteroptions = JFactory::getApplication()->input->get("filteroptions", "", "raw");
	...
	function export(){
		$db = JFactory::getDBO();
		$field_id = JFactory::getApplication()->input->get("fields", "0", "raw");
		...
		$filteroptions = JFactory::getApplication()->input->get("filteroptions", "0", "raw");
		...
		if($type == "calendar"){
			$filteroptions = JFactory::getApplication()->input->get("datefield", "0", "raw");
		}
