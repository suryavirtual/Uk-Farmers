...
<form method="post" name="adminForm" id="adminForm">
	<ul class="nav nav-tabs" id="myTab">
		 ...
		 <li><a href="#filter-tab" data-toggle="tab"><?php echo JText::_('ARRA_FILTER_FIELDS_PROFILE')?></a>
	</ul>
			...
			<table width="100%" class="table">
				<tr>
					<td colspan="7" align="left">
						<input class="bth btn-success" type="submit" name="recreatefields" value="<?php echo JText::_("ARRA_RECREATE_FIELDS_BUTTON"); ?>" onclick="document.adminForm.task.value='recreatefields'" />
					</td>
				</tr>
				<tr>
				...
				?>
                            <tr>
                                ...
                                <td>
                                    <input class="btn btn-warning" style="width:60px;" onclick="javascript:deleteField('<?php echo @$value["name"]; ?>', '<?php echo $value["type"]; ?>');" name="delete" value="<?php echo JText::_("ARRA_DELETE"); ?>" />
                                </td>
                            </tr>
				<?php	
							$i++;
				...
				<table style="margin:auto;">
					<tr>
						<td align="center" class="td_settings_options" style="text-align:center !important;">
							...
							<select onchange="javascript:setAdditionalColumn(this);" name="number_columns">
							<?php 
						...
						<td>
							<table style="margin:auto;">
								...
								?>
										<tr>
											<td>
												<div id="column<?php echo $i; ?>" style="display:none; font-weight:bold;" class="well well-minimized">
													<table class="table">
														<tr>
															<td valign="top">
				...
				<legend>
					...
					<table>
						...
						<tr>
							...
							<td id="divsearch" style="display:none; height:80px;">
