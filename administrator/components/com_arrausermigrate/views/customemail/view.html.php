...
class ArrausermigrateViewCustomemail extends JViewLegacy{
	...
	function custom_email(){		
		...
		$emailSettings .=           "<input type=\"button\" class=\"btn btn-success\" name=\"save_email_export\" value=\"".JText::_("ARRA_SAVE_EMAIL_EXPORT_BUTTON")."\" onClick=\"javascript:saveEmailExportSettings();\">";
		$emailSettings .=        "</td>";
		$emailSettings .=     "</tr>";
		$emailSettings .=     "<tr>";
		...
		$emailSettings .=     "</tr>";
		$emailSettings .=     "<tr>";
		$emailSettings .=         "<td class=\"td_settings_2\"  colspan='2'><div class=\"alert alert-info\"><b>";
		$emailSettings .=             JText::_("ARRA_EMAIL_TEMPLATE_NOTE");
		$emailSettings .=         "</b></div></td>";
		$emailSettings .=     "</tr>";
