...
class ArrausermigrateViewLanguage extends JViewLegacy{
	...
	function languageFile(){
	    $filename = JPATH_ROOT.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."language".DIRECTORY_SEPARATOR."en-GB".DIRECTORY_SEPARATOR."en-GB.com_arrausermigrate.ini";
