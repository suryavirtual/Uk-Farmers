...
class ArrausermigrateModelDelete extends JModelLegacy{
	...
	function deleteUsers(){
		$group_ids = JFactory::getApplication()->input->get("usertype", array(), "raw");
		...
		$start_date_visited = JFactory::getApplication()->input->get("start_date", "", "raw");
		$end_date_visited = JFactory::getApplication()->input->get("end_date", "", "raw");
		$activated = JFactory::getApplication()->input->get("activated", "", "raw");
		$block = JFactory::getApplication()->input->get("block", "", "raw");
		$user_ids = JFactory::getApplication()->input->get("cid", array(), "raw");
		$username_list = JFactory::getApplication()->input->get("username_list", "", "raw");
