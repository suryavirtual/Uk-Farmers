...
class ArrausermigrateModelArrausermigrate extends JModelLegacy{	
	...
	function getActualVersion(){   
		$path = JPath::clean(JPath::clean(JPATH_SITE).DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_arrausermigrate".DIRECTORY_SEPARATOR."install.xml");
		$version = "";
	...
	function getLatestVersion(){		
		...
		if($this->isCurlInstalled() == true){
			...
			$data = "http://www.joomlarra.com/arralicense.txt";
			$ch = @curl_init($data);
