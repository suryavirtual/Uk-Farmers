function statistics(users){
	...
	var req = new Request.HTML({
		...
		url: 'index.php?option=com_arrausermigrate&controller=statistics&task=statistics_ajax&usertype='+usertype+"&block="+block_unblock+"&visited="+visited+"&start_date="+start_date+"&end_date="+end_date+"&start_register_date="+start_register_date+"&end_register_date="+end_register_date+"&send_email="+send_email+"&activated="+activated,
		data: { 'do' : '1' },
